...
MAX_TRADES_PER_HOUR = _get_int("MAX_TRADES_PER_HOUR", 8)
MAX_LOW_CAP_OPEN_POSITIONS = _get_int("MAX_LOW_CAP_OPEN_POSITIONS", 2)
...
PREDICTIVE_FLOW_ENABLED = _get_bool("PREDICTIVE_FLOW_ENABLED", True)
PREDICTIVE_FLOW_CONFLICT_PENALTY = _get_float("PREDICTIVE_FLOW_CONFLICT_PENALTY", 0.08)
PREDICTIVE_FLOW_MIN_STRENGTH = _get_float("PREDICTIVE_FLOW_MIN_STRENGTH", 0.22)
...
OPEN_POSITIONS_CHECK_SECONDS = _get_int("OPEN_POSITIONS_CHECK_SECONDS", 10)
...
MIN_STRONG_SIGNAL_RR = _get_float("MIN_STRONG_SIGNAL_RR", 1.5)
MIN_B_SIGNAL_RR = _get_float("MIN_B_SIGNAL_RR", 1.35)
MIN_BASE_A_RR = _get_float("MIN_BASE_A_RR", 1.8)
MIN_OB_A_RR = _get_float("MIN_OB_A_RR", 1.8)
MIN_WEAK_REAL_RR = _get_float("MIN_WEAK_REAL_RR", 2.2)
MIN_LOW_CAP_REAL_RR = _get_float("MIN_LOW_CAP_REAL_RR", 2.6)
MAX_WEAK_SIGNAL_ATR_PCT = _get_float("MAX_WEAK_SIGNAL_ATR_PCT", 0.03)
ENABLE_OB_COUNTER_IMPULSE_BLACKLIST = _get_bool("ENABLE_OB_COUNTER_IMPULSE_BLACKLIST", True)
ENABLE_BASE_COUNTER_IMPULSE_BLACKLIST = _get_bool("ENABLE_BASE_COUNTER_IMPULSE_BLACKLIST", True)
ANOMALY_WICK_FILTER_ENABLED = _get_bool("ANOMALY_WICK_FILTER_ENABLED", True)
MAX_15M_CANDLE_MOVE_PCT = _get_float("MAX_15M_CANDLE_MOVE_PCT", 0.06)
MAX_1H_CANDLE_MOVE_PCT = _get_float("MAX_1H_CANDLE_MOVE_PCT", 0.12)
MAX_WICK_TO_RANGE_RATIO = _get_float("MAX_WICK_TO_RANGE_RATIO", 0.55)
MAX_SPIKE_ATR_MULT = _get_float("MAX_SPIKE_ATR_MULT", 2.5)
REAL_SAFE_DAILY_LOSS_PCT = _get_float("REAL_SAFE_DAILY_LOSS_PCT", 0.05)
REAL_SAFE_MAX_CONSECUTIVE_LOSSES = _get_int("REAL_SAFE_MAX_CONSECUTIVE_LOSSES", 4)
MAX_SYMBOL_CONSECUTIVE_LOSSES = _get_int("MAX_SYMBOL_CONSECUTIVE_LOSSES", 2)
SYMBOL_LOSS_COOLDOWN_SECONDS = _get_int("SYMBOL_LOSS_COOLDOWN_SECONDS", 14400)
